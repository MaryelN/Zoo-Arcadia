 ...
 */
final class Version20240717220302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, habitat_id_id INT NOT NULL, race_id_id INT DEFAULT NULL, image_id_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, details VARCHAR(100) DEFAULT NULL, votes INT DEFAULT NULL, UNIQUE INDEX UNIQ_6AAB231F5E237E06 (name), INDEX IDX_6AAB231F20AE7A39 (habitat_id_id), INDEX IDX_6AAB231F997ABF46 (race_id_id), INDEX IDX_6AAB231F68011AFE (image_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE animal_report (id INT AUTO_INCREMENT NOT NULL, animal_id_id INT NOT NULL, user_id_id INT NOT NULL, proposed_food VARCHAR(100) NOT NULL, proposed_quantity VARCHAR(50) DEFAULT NULL, details VARCHAR(100) DEFAULT NULL, health VARCHAR(150) NOT NULL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7EDEB2585EB747A3 (animal_id_id), INDEX IDX_7EDEB2589D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, comment VARCHAR(150) NOT NULL, validation TINYINT(1) DEFAULT 0 NOT NULL, email VARCHAR(50) NOT NULL, rating SMALLINT NOT NULL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, animal_id_id INT NOT NULL, image_name VARCHAR(100) NOT NULL, image_size INT NOT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_C53D045F5EB747A3 (animal_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, lastname VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
