 ...
 */
final class Version20240710140309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal_report (id INT AUTO_INCREMENT NOT NULL, animal_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, proposed_food VARCHAR(100) DEFAULT NULL, proposed_quantity VARCHAR(50) DEFAULT NULL, details VARCHAR(200) NOT NULL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7EDEB2585EB747A3 (animal_id_id), INDEX IDX_7EDEB2589D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE food_repport (id INT AUTO_INCREMENT NOT NULL, animal_id_id INT NOT NULL, user_id_id INT DEFAULT NULL, date_hour DATETIME NOT NULL, food_quantity VARCHAR(50) NOT NULL, details VARCHAR(50) DEFAULT NULL, INDEX IDX_6A3A3EB25EB747A3 (animal_id_id), INDEX IDX_6A3A3EB29D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE role (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_57698A6AEA750E8 (label), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, role_id_id INT NOT NULL, email VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, password VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64988987678 (role_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE food_repport ADD CONSTRAINT FK_6A3A3EB25EB747A3 FOREIGN KEY (animal_id_id) REFERENCES animal (id)');
        $this->addSql('ALTER TABLE food_repport ADD CONSTRAINT FK_6A3A3EB29D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE food_repport DROP FOREIGN KEY FK_6A3A3EB25EB747A3');
        $this->addSql('ALTER TABLE food_repport DROP FOREIGN KEY FK_6A3A3EB29D86650F');
        ...
        $this->addSql('DROP TABLE food_repport');
