 ...
 */
final class Version20240718153908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, habitat_id INT NOT NULL, race_id INT DEFAULT NULL, image_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, details VARCHAR(100) DEFAULT NULL, votes INT DEFAULT NULL, UNIQUE INDEX UNIQ_6AAB231F5E237E06 (name), INDEX IDX_6AAB231FAFFE2D26 (habitat_id), INDEX IDX_6AAB231F6E59D40D (race_id), INDEX IDX_6AAB231F3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
